    ...
    public static class BodyPart implements LivingPart {
        ...
        public String toString() {
            ...
            if (o instanceof String) {
                String s = (String) o;
                if (s.equals("Yes")) {b = true;}
                if (s.equals("No")) {b = false;}
            }
            return b ? name + " содержит кости" : name + " не содержит кости";
        }
    }
